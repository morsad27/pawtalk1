    ...
    const SaveFormData = async (imageUrl) => {
        ...
        try {
            ...
            await setDoc(doc(db, 'Pets', docId), {
                ...formData,
                imageUrl: imageUrl,
                username: user?.fullName || 'Anonymous', // Use a default value if undefined
                email: user?.name, // Change from primaryEmailAddress?.emailAddress to just user?.name
        ...
        <ScrollView style={{
            ...
            <TouchableOpacity
                ...
                {loader ? <ActivityIndicator size={'large'} /> :
                    <Text style={{ fontFamily: 'medium' }}>Submit</Text>}
            </TouchableOpacity>
        </ScrollView>
    )
}
